...
---
<Note title="Try Our Agentic Installation Wizard ✨" type="success">

Skip the manual steps! We built an intelligent one-liner that handles everything for you automatically.
