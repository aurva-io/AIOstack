...
**Step 0:** Create an Account and Get Your Credentials

1. Go to [staging.aurva.ai](https://staging.aurva.ai) and sign up for an account.  
2. After registering, you will receive a **Company ID** and a **Token**.  
3. Download the **Outpost Service Helm YAML** and add your Company ID and Token to it.  

>  Note: Validation happens securely inside your cluster. **No inbound internet access is required**.

<img src="/signup_screen.png" alt="Helm Installation Step 0"  width="80%" />
