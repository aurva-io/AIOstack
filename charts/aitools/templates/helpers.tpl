...
Common labels
*/}}
{{- define "aitools.labels" -}}
helm.sh/chart: {{ include "aitools.chart" . }}
{{ include "aitools.selectorLabels" . }}
{{- if .Chart.AppVersion }}
