  ...
  <section class="v4-section v4-bordered">
    <div class="v4-container">
      <div class="v4-section-head">
        <span class="v4-section-num">§ 04</span>
        <h2 class="v4-h2">
          Six outcomes.<br>
          One install.
        </h2>
      </div>
      <div class="v4-outcomes">
        <div v-for="(c,i) in cells" :key="i" class="v4-outcome">
          <div class="v4-outcome-num">{{ c.i }}</div>
          <div class="v4-outcome-t">{{ c.t }}</div>
          <div class="v4-outcome-s">{{ c.s }}</div>
        </div>
      </div>
    </div>
  </section>
